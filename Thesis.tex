...
{\hypersetup{colorlinks=true,        
    ...
    urlcolor=russet,           
    citecolor=blue}
 \include{Main/Chapter1/Chapter1}    % iontroduccion hipotesis objetivos
 \include{Main/Chapter2/Chapter2}    %  arte
\include{Main/Chapter3/Chapter3}    % Teoria herramientas
}
{\hypersetup{colorlinks=true,        
    linkcolor=blue,         
    filecolor=magenta,       
    urlcolor=russet,           
    citecolor=blue}
\include{Main/Chapter4/Chapter4}      % Teoria modelacion
}
{\hypersetup{colorlinks=true,        
    linkcolor=blue,         
    filecolor=magenta,       
    urlcolor=russet,           
    citecolor=blue}
 \include{Main/Chapter5/Chapter5}    % Parametros robot delta tesis nuestra
 \include{Main/Chapter6/Chapter6}      % Desarrollo 
%\include{Main/Chapter7/Chapter7}    % Resultados  ESTE ES EL MAS PESADO!
%\include{Main/Chapter8/Chapter8}    % Colcusiones
}

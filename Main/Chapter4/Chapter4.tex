...
\subsection{Modelación cinemática de la velocidad}\label{mb_cvel}
    ...
    \subsection{Modelación Dinámica}
        ...
        resumen del cap,en esta seccion ,referencias, paderborn  
        ...
        En el Apéndice A.1, la derivación para el modelo dinámico del robot paralelo Delta se presenta utilizando el enfoque del principio de trabajo virtual presentado por [3 trabajo dvirtuiar de cododot decir las 3 referenciuas
        ...
        \begin{figure}[H]
              \centering
	          \includegraphics[width=0.4\linewidth]{Main/Chapter4/Images4/cap4_dina_b_1.png}
              \caption{Fotografía de un paraguas}

...
INSPIRACIONB MODELO TESIS    
        \cite{Path_Planning_and_Trajectory_Optimization}  
...
MODELOS DINAMICOS        
        [140]
        J. F. Kleinfinger, Modélisation dynamique des robots à chaîne simple, 
        \cite{kleinfinger1986modelisation}
        [141] 
        T. Kokkinis and R. Stoughton, “Dynamics and control of closed-chain robot
        arms with application to a new direct-driven robot arm,” International
        Journal of Robotics and Automation, vol. 6, no. 1, pp. 25–34, 1991.
        \cite{kokkinis1991dynamics}
        [142] 
        Y. Nakamura, Advanced Robotics: Redundancy and Optimization. Boston,
        MA, USA: Addison-Wesley Longman Publishing Co., Inc., 1st ed., 1990.
        \cite{NakamuraYoshihiko1991Ar}
        [143] 
        L.-C. Wang and C. C. Chen, “On the dynamic analysis of general parallel
        robotic manipulators,” International Journal of Robotics and Automation,
        vol. 9, no. 2, pp. 81–87, 1994.
        \cite{wang1994dynamic}

TRABAJO VIRTUAL
        [3]         
        \cite{Codourey_decoupling} 
        [129]
        A. Codourey, Contribution á la commande des robots rapides et précis.
        Application au robot DELTA à centraînement direct. 
        \cite{Codourey:31400} 
        [144]
        A. Codourey and E. Burdet, “A body-oriented method for finding a linear
        form of the dynamic equation of fully parallel robots,”
        \cite{bodyoriente} 
        [145]
        C.-D. Zhang and S.-M. Song, “An efficient method for inverse dynamics
        of manipulators based on the virtual work principle,”
        \cite{zhang1993efficient} 
        [146]
        Z. Ji, “Study of the effect of leg inertia in stewart platforms
        \cite{StudyinertiaStewart} 

            \newpage
    
    \subsubsection{Tipos de Modelos}
    
        introduccion tipos de dinamica

        \subsubsection{Trabajo Virtual}
    
        trabajo virtual utilizado
    ...
    \subsubsection{Dinámica Inversa}
        ...
        \paragraph{Simplificaciones e Hipotesis}
        \paragraph{Parametros dinamicos}
        \paragraph{Modelo Dinamico basado en principio de trabajo virtual}
        \paragraph{paragraph}

...
diagrama tree ROS, ADAMS , RVIZ

Validación Cinemática y Dinámica

    QUIZAS SACAR ESTA SECCION ELIMINAR
    ...
    sin nomrne de funciones solo los pasos
    
    VER CAPITULO ARQUITECTURA PRIMER DIAGRAMA DE FLUJO
    

    Codigo seudocodigo O MEJOR DIAGRAMA DE FLUJO HACIA ABAJO POR PASOS

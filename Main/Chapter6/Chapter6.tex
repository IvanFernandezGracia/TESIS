...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance = 2cm, auto]
        ...
        \node [decision, below of=restri] (cumple) {¿Cumple con restricciones? Figura \ref{fig:my_label_ws_cap6_1}};

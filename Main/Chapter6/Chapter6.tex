...
\section{Interfaz de visualización Rviz}
   ...
   % DIAGRAMA DE FLUJO COMO EL DE FUNCIONES DE SOFARE ROS 
    ...
    %2 POSICIONADOR RVIZ TIEMPO REAL 
    %3 XML URFD 
    %4 CONEXION XML URFD CON TF CON RVIZ NOMBRE ELEMENTOS
...
%               \newpage
       ...
       \subsubsection{Base Movil}
        ...
        La base movil es un enlace que se le nombra \textbf{'actuador'} y se representa como un cilindro de radio \textbf{$R_b$}. La posición y orientación de este enlace no es respecto a ningún otro link, solo se determina en relación al sistema de referencia global.

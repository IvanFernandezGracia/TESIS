+\chapter{Desarrollo de la solución}\label{CAP6}
    ...
    \begin{tikzpicture}[node distance=2em]
        ...
        \node (S1) [process, below of=S, yshift= -2em]{\textbf{Trayectoria}};
        \node (S2) [process, below of=S1, yshift=-2em]{\textbf{Cinematica Inversa}};
        \node (S3) [process, below of=S2, yshift=-2em]{\textbf{Vizualizacion}};
        \node (S4) [process, below of=S3, yshift=-2em]{\textbf{Guardar Trayectoria}};
        \node (S5) [process, below of=S4, yshift=-2em]{\textbf{Velocidad y Aceleracion de los Actuadores}};
        \node (S6) [process, below of=S5, yshift=-2em,]{\textbf{Torque Motores.}};
        \node (S7) [process, below of=S6, yshift=-2em,]{\textbf{Guardar Torque}};
        \node (S8) [startend, below of=S7, yshift=-2em]{ADAMS};
        \node (S9) [process, below of=S8, yshift=-2em]{\textbf{importacion}};
        \node (S10) [process, below of=S9, yshift=-2em,]{\textbf{Dibujar}};
        \node (S11) [process, below of=S10, yshift=-2em,]{\textbf{Trayectoria}};    
        \node (S12) [process, below of=S11, yshift=-2em,]{\textbf{Guardar Torque}};
        \node (S13) [startend, below of=S12, yshift=-2em]{\textbf{Validacion Cinematica y Dinamica}};
        \node (S14) [process_final, right of=S13, xshift=20em,]{\textbf{Comparar Torques}};
        \draw [line] (S) -- (S1);
        \draw [line] (S1) -- (S2);
        \draw [line] (S2) -- (S3);
        \draw [line] (S3) -- (S4);
